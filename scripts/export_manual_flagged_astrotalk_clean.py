...
{FAKE_REMEDIES, PERSONAL_DATA_COLLECTION, INSTIGATION, FEAR_MANIPULATION}, it is
skipped. A session is kept when it mixes one of those with any other category
(e.g. NSFW).
